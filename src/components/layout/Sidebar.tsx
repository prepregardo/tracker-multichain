...
export default function Sidebar() {
  ...
  return (
        <aside className="fixed inset-y-0 left-0 z-30 w-64 bg-gray-900 border-r border-gray-800">
              <div className="flex h-16 items-center gap-3 px-6 border-b border-gray-800">
                      <div className="h-8 w-8 rounded-lg bg-brand-600 flex items-center justify-center">
                                <span className="text-white font-bold text-sm">TC</span>span>
                      </div>div>
                      <span className="text-white font-semibold text-lg">Tracker</span>span>
              </div>div>
