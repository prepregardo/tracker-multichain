        ...
        <>
                  ...
                  <form onSubmit={handleSubmit} className="card max-w-lg space-y-4">
                            <div>
                                        ...
                                        <select
                                                        ...
                                                        className="input"
                                                      >
                                                      <option value="ERC20">ERC20 (Ethereum)</option>option>
                                                      <option value="TRC20">TRC20 (TRON)</option>option>
                                        </select>select>
                            </div>div>
                            <div>
                            ...
                            <div>
                                        <label className="label">Label (optional)</label>label>
                                        <input
                                                        type="text"
                                                        value={label}
          ...
          {formMode === 'bulk' && (
                  <form onSubmit={handleBulkSubmit} className="card max-w-2xl space-y-4">
                            <div>
                                        <label className="label">Network (for all wallets)</label>label>
                                        <select
                                                        value={bulkNetwork}
                            ...
                            <div>
                                        ...
                                        <div className="flex justify-between mt-2 text-sm">
                                          ...
                                          {addressCount > 300 && (
                                    <span className="text-red-400">Maximum 300 allowed</span>span>
                                                      )}
                                        </div>div>
                            </div>div>
                            <button
                    ...
                    {bulkResult && (
                                <div className="rounded-lg border border-green-500/30 bg-green-500/10 p-4 space-y-1">
                                              <p className="text-green-400 font-medium">Bulk import complete!</p>p>
                                              <p className="text-sm text-gray-300">
                                                              Created: <span className="text-green-400 font-mono">{bulkResult.created}</span>span>
                                              </p>p>
                                              <p className="text-sm text-gray-300">
                                                              Already existed (skipped): <span className="text-yellow-400 font-mono">{bulkResult.skipped}</span>span>
                                              </p>p>
                                  {bulkResult.duplicatesInInput > 0 && (
                                                  <p className="text-sm text-gray-300">
                                                                    Duplicates in input: <span className="text-orange-400 font-mono">{bulkResult.duplicatesInInput}</span>span>
                                                  </p>p>
                                              )}
                                              <p className="text-sm text-gray-300">
                                                              Total unique: <span className="text-gray-100 font-mono">{bulkResult.total}</span>span>
                                              </p>p>
                                </div>div>
                            )}
                  </form>form>
          ...
          {initialWallets.length === 0 ? (
                  <div className="card text-center py-12">
                            <p className="text-gray-500">No wallets added yet. Add your first wallet to start tracking.</p>p>
                  </div>div>
                ) : (
                            ...
                            <table className="w-full">
                                        <thead>
                                                      <tr className="border-b border-gray-800">
                                                                      ...
                                                                      <th className="table-header">Address</th>th>
                                                                      <th className="table-header">Label</th>th>
                                                                      <th className="table-header">Added</th>th>
                                                                      <th className="table-header">Actions</th>th>
                                                      </tr>tr>
                                        </thead>thead>
                                    ...
                                    <tr key={wallet.id} className="hover:bg-gray-800/50">
                                                      ...
                                                      <td className="table-cell">{wallet.label || '-'}</td>td>
